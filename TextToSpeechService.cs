...
namespace FinanceBot
{
    public class TextToSpeechService
    {
        ...
        public string GenerateSsml(string message, string language, string detectedLanguageCode)
        {
            try
            {
            ...
            if (string.IsNullOrEmpty(_voiceFontName))
            {
                ...
                switch (detectedLanguageCode)
                {
                    case "hi-IN":
                        ...
                        voiceLanguage = detectedLanguageCode;
                        break;
                    case "en-US":
                    ...
                    case "ta-IN":
                        ...
                        break;
                    case "te-IN":
                        voiceName = "Microsoft Server Speech Text to Speech Voice (te-IN, Chitra)";
                        voiceLanguage = detectedLanguageCode;
                        break;
                }
                //voiceName = "Microsoft Server Speech Text to Speech Voice (en-IN, Heera, Apollo)";
